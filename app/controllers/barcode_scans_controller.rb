class BarcodeScansController < ApplicationController
  ...
  private
    ...
    def barcode_scan_params
      params.require(:barcode_scan).permit(:barcode_reader_id, :order_id, :mrn, :patient_name, :admin_dose, :drug_name,
                                           :brand_name, :med_id, :admin, :sig)
    end
end
